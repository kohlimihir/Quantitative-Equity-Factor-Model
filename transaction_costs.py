...
Analyzes portfolio turnover and net-of-cost performance with different
cost assumptions (5bps, 10bps, 20bps round-trip).
"""
...
def compute_turnover(sector_predictions_path, top_per_sector=TOP_PER_SECTOR):
    """Compute actual monthly turnover after threshold rebalancing."""
...
def plot_cost_scenarios(portfolio_path, turnover_df,
    ...
    """Plot cumulative returns under different cost scenarios."""
    gross, _, _ = apply_transaction_costs(portfolio_path, turnover_df, 0)
    ...
    ax2.set_title("Monthly Portfolio Turnover",
...
def plot_sharpe_sensitivity(portfolio_path, turnover_df,
    ...
    """Plot Sharpe ratio sensitivity to transaction costs."""
